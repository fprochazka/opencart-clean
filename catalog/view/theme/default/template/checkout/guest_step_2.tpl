        ...
        <table width="536" cellpadding="3">
          ...
          <tr>
            <td width="1">
              ...
              <?php } ?></td>
            <td width="534"><label for="<?php echo $payment_method['id']; ?>" style="cursor: pointer;"><?php echo $payment_method['title']; ?></label></td>
			<?php // PAYMENT METHOD PRICE ?>
			<td width="1" align="right"><label for="<?php echo $payment_method['id']; ?>" style="cursor: pointer;">
			  <?php	if (isset($payment_method['text'])) {echo $payment_method['text'];}?></label>
			</td>
			<?php // PAYMENT METHOD PRICE END?>
          </tr>
          <?php } ?>
        </table>
      </div>
