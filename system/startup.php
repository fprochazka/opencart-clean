...
require_once '/home/hosiplan/develop/libs/nette/dev/Nette/loader.php';
$configurator = new Nette\Config\Configurator;
$configurator->enableDebugger(__DIR__ . '/logs', 'hosiplan@gmail.com');
$configurator->setTempDirectory(__DIR__ . '/cache');
$configurator->addConfig(__DIR__ . '/config/config.neon');
$container = $configurator->createContainer();
$container->httpRequest; // fetch request before "cleanup"
unset($configurator);


//if (file_exists($xhprof = '/home/hosiplan/develop/libs/xhprof/external/header.php')) {
//	require_once $xhprof;
//}
...
require_once(DIR_SYSTEM . 'helper/ini.php');
