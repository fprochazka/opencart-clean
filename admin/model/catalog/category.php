...
class ModelCatalogCategory extends Model {
	...
	public function getCategoryDescriptions($category_id, $language_id = NULL) {
		$category_description_data = array();

		$langWhere = $language_id !== NULL ? " AND language_id = '" . (int)$language_id . "'" : NULL;
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "category_description WHERE category_id = '" . (int)$category_id . "' $langWhere");
		...
		if ($language_id !== NULL) {
			return $category_description_data
				? $category_description_data[$language_id]
				: NULL;
		}
